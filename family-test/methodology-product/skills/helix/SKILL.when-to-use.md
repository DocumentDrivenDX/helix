---
name: helix
description: HELIX product methodology — the family's product flow (PRDs, vision, features, ADRs, technical designs, test plans, runbooks, release notes).
when_to_use: |
  ...
  Do NOT use for infrastructure work (terraform/opentofu), website content
  authoring, or sales/ops work — those are sibling skills (helix-infra,
  helix-web, etc.).
